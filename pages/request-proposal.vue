  ...
  <main>
    <section class="container mx-auto mb-20">
      <div class="flex items-center rounded-sm" style="background-color:#e8e8e8">
        <div
          class="flex-1"
          style="background-size:cover;min-height:609px;background:#e8e8e8 url('https://static1.squarespace.com/static/57720d02725e25bae63ac3f3/t/5b3c2f921ae6cf89ccfca3b8/1533959811785/squarespace-designer.jpg?format=1500w')"
        ></div>
        <div class="flex-1 flex flex-col items-center text-center uppercase tracking-widest">
          <h1 class="text-xl mb-6">Request a Proposal</h1>
          <h3 class="text-sm mb-16">
            That will clearly express your style
            <br>&amp; communicate your message
          </h3>
          <nuxt-link
            class="px-5 py-2 text-xs text-white bg-black rounded-sm focus:outline-none focus:shadow-outline"
            to="/contact-us"
    ...
    <section class="container mx-auto mb-20">
      <div class="flex flex-row-reverse items-center rounded-sm" style="background-color:#e8e8e8">
        <div
          class="flex-1"
          style="background-size:cover;min-height:609px;background:right #e8e8e8 url('https://static1.squarespace.com/static/57720d02725e25bae63ac3f3/t/5bfa258803ce64e76c230d17/1543120271790/architect-web-design-and-branding.jpg?format=1500w')"
        ></div>
        <div class="flex-1 flex flex-col items-center text-center uppercase tracking-widest">
    ...
    <section class="container mx-auto mb-20">
      <div class="flex items-center py-10 rounded-sm" style="background-color:#e8e8e8">
        <div
          class="flex-1 rounded rounded-l-none shadow"
